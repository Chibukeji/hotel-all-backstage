<template>
  <div>
    <el-dialog :visible.sync="imgDialogVisible" title="相册" width="800px" class="center-dialog imgGallery">
        ...
        <div class="right-img-box">
          <div class="top-btn">
            ...
            <el-upload
              ...
              name="image"
              :data="{group_id:group_id, group_type:group_type,uid:userId}"
              :show-file-list="false"
            >
              <el-button v-if="groupList.length>0" size="small" type="primary">上传图片</el-button>
            </el-upload>
...
export default {
  ...
  data() {
    return {
      ...
      upload_picture: `${process.env.VUE_APP_BASE_API}/upload`,
      imgInit:true,
      selectGroup:'',
      listQuery:{
        page:1,
  ...
  methods: {
    init(flag,type) {
      ...
      let loginForm = JSON.parse(localStorage.getItem('loginUserName'))
      this.userId = loginForm.user_id
      this.groupList = []
      this.groupImgList = []
